        ...
        <header
            ...
            <nav class="relative z-10 container mx-auto flex justify-between items-center">
                <ul class="flex items-center gap-12">
                    ...
                    <li ref="aboutEl">
                        <a href="#about" :class="activeLinkIndex === 1 ? 'font-bold text-[#F44336]' : 'text-gray-400'"
                            class="mx-1 text-lg hover:font-bold hover:text-[#F44336]" @click="setActiveLink(1)">About
                        </a>
                    </li>
                    <li ref="skillsEl">
                        <a href="#skills" :class="activeLinkIndex === 2 ? 'font-bold text-[#F44336]' : 'text-gray-400'"
                            class="mx-1 text-lg hover:font-bold hover:text-[#F44336]" @click="setActiveLink(2)">Skills
                        </a>
                    </li>
                    <li ref="worksEl">
                        <a href="#works" :class="activeLinkIndex === 3 ? 'font-bold text-[#F44336]' : 'text-gray-400'"
                            class="mx-1 text-lg hover:font-bold hover:text-[#F44336]" @click="setActiveLink(3)">Works
                        </a>
                    </li>
                    <li ref="contactEl">
                        <a href="#contact" :class="activeLinkIndex === 4 ? 'font-bold text-[#F44336]' : 'text-gray-400'"
        ...
        <footer>
            <div
                ...
                <div class="flex justify-center gap-4 m-3">
                    ...
                    <a href="https://linkedin.com/in/mochammadrs" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-white transition-transform duration-300 hover:scale-125"
                        aria-label="LinkedIn">
                        <Icon name="mdi:linkedin" class="text-3xl" />
                    </a>
                    <a href="https://instagram.com/mochammadrs_" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-white transition-transform duration-300 hover:scale-125"
                        aria-label="Instagram">
                        <Icon name="mdi:instagram" class="text-3xl" />
                    </a>
                    <a href="https://facebook.com/rebellious0209" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-white transition-transform duration-300 hover:scale-125"
                        aria-label="Facebook">
                        <Icon name="mdi:facebook" class="text-3xl" />
                    </a>
                    <a href="https://x.com/mochammadrs_" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-white transition-transform duration-300 hover:scale-125"
                        aria-label="Twitter">
